...
<SharePoint:UIVersionedContent UIVersion="4" runat="server">
	...
	<table cellpadding="0" cellspacing="0" id="onetIDListForm" style="width:100%;display:none;margin-top:10px;">
	 <tr>
	  <td>
          <div id="tabs">
	<ul>
    	<li><a href="#tabs-1">General</a></li>
    	<li><a href="#tabs-2">Airborne Ops Fields (optional)</a></li>
    	<li><a href="#tabs-3">Cargo Fields (optional)</a></li>
	</ul>
	<div id="tabs-1">
        <WebPartPages:WebPartZone runat="server" FrameType="None" ID="Main" Title="loc:Main" />
	</div>
	<div id="tabs-2">
    	<table id="tblAirborneOps" class="ms-formtable" style="margin-top: 8px;" border="0" cellpadding="0" cellspacing="0" width="100%">		
		</table>        
	</div>
	<div id="tabs-3">
		<table id="tblCargo" class="ms-formtable" style="margin-top: 8px;" border="0" cellpadding="0" cellspacing="0" width="100%">		
		</table> 
	</div>               
</div>
...
<script type="text/javascript">
    ...
    ExecuteOrDelayUntilScriptLoaded(function () {
        require(['../../app/js/common'], function (common) {
            require(['newForm.js'], function (UI) {
                UI.render();
            });
        });
